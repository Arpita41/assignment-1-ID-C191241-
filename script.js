...
const totalIncome2 = document.getElementById("total-income-expense");
const totalBudget = document.getElementById("total-income-budget");
...
function calculateExpense() {
  ...
  totalIncome2.innerHTML = formatMoney(sum1);
}
calculateExpense();
...
function calculateBudget() {
  ...
  const income = calculateIncome1();
  const expense = calculateExpense1();
...
function deleteEntry(element) {
  element.remove();
  // Update total income and budget after deleting entry
  calculateIncome();
  calculateExpense();
  calculateBudget();
}
